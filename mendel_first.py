...
def calc_offspring_probs(homo_dominant:int, hetero:int, homo_recessive:int)->float:
    ...
    prob_Dd = (0.5*prob_k1_m2) + (prob_k1_n2) + (0.5*prob_m1_k2) + (0.5*prob_m1_m2) + (0.5*prob_m1_n2) + (prob_n1_k2) + (0.5*prob_n1_m2)
    prob_dd = (0.25*prob_m1_m2) + (0.5*prob_m1_n2) +(0.5*prob_n1_m2) + (prob_n1_n2)
